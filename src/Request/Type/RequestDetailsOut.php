...
class RequestDetailsOut
{
    ...
    /**
     * @param \OpenEuropa\EPoetry\Request\Type\OriginalDocumentOut|null $originalDocument
     * @return $this
     */
    ...
    /**
     * @param \OpenEuropa\EPoetry\Request\Type\AuxiliaryDocuments|null $auxiliaryDocuments
     * @return $this
     */
