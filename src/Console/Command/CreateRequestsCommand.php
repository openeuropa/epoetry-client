...
class CreateRequestsCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('in-format', 'in', InputOption::VALUE_OPTIONAL, 'Format for the input.', 'xml')
            ->addOption('out-format', 'out', InputOption::VALUE_OPTIONAL, 'Format for the output.', 'xml')
